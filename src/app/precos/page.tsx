    ...
    <div className="min-h-screen px-4 py-16 sm:px-6 lg:px-8 max-w-6xl mx-auto space-y-16">
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-2 border-b border-slate-800 pb-3">
          <Building2 className="h-6 w-6 text-solana-purple" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* IES CAMPUS PRO */}
          <div className="glass-panel rounded-3xl p-6 border-solana-purple/40 glow-purple flex flex-col justify-between space-y-6 relative">
            <div className="absolute -top-3 right-6 rounded-full bg-solana-purple px-3 py-0.5 text-[10px] font-bold text-white uppercase tracking-wider">
              Mais Popular
            </div>
            <div className="space-y-3">
              <span className="text-xs font-semibold uppercase tracking-wider text-solana-purple">
                Campus Completo
              </span>
            ...
            <button
              ...
              className="w-full text-center rounded-full bg-solana-purple py-2.5 text-xs font-bold text-white shadow-md shadow-solana-purple/20 hover:bg-solana-purpleDeep hover:scale-[1.01] transition-all"
            >
