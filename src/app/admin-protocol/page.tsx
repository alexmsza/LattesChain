    ...
    <div className="min-h-screen px-4 py-12 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="inline-flex rounded-xl bg-slate-900/90 border border-slate-800 p-1">
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold transition-all ${
              activeTab === "users"
                ? "bg-solana-purple text-white shadow-md shadow-solana-purple/20"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        ...
        <div className="glass-panel rounded-2xl p-5">
          ...
          <div className="text-[11px] text-solana-purple mt-1">100% Homologadas On-Chain</div>
        </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="rounded-xl border border-slate-700 bg-navy-900/90 pl-9 pr-4 py-2 text-xs text-white placeholder-slate-500 focus:border-solana-purple focus:outline-none"
                />
              </div>
              ...
              <select
                ...
                className="rounded-xl border border-slate-700 bg-navy-900/90 px-3 py-2 text-xs font-semibold text-white focus:border-solana-purple focus:outline-none"
              >
            ...
            <form onSubmit={handleRegisterInstitution} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-700 bg-navy-900/90 px-3.5 py-2 text-sm text-white focus:border-solana-purple focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-700 bg-navy-900/90 px-3.5 py-2 text-xs font-mono text-white focus:border-solana-purple focus:outline-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-solana-purple py-2.5 text-sm font-bold text-white hover:bg-solana-purpleDeep disabled:opacity-50"
              >
